...
namespace DFC.Api.Lmi.Import.Functions
{
    ...
    public class ApiDefinition
    {
        ...
        private const string ApiDefinitionDescription = "National Careers Service LMI Import API is a RESTful API that provides a simple and consistent approach to importing LMI data form LMI For All APIs.";
