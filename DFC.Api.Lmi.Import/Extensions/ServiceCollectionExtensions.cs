...
namespace DFC.Api.Lmi.Import.Extensions
{
            ...
            where TClientOptions : ClientOptionsModel, new()
        {
            return services
                    ...
                    .ConfigureHttpClient((sp, options) =>
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(httpClientOptions.Version))
                        {
                            options.DefaultRequestHeaders.Add(nameof(httpClientOptions.Version), httpClientOptions.Version);
                        }
