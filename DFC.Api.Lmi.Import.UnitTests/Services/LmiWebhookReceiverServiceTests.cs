...
namespace DFC.Api.Lmi.Import.UnitTests.Services
{
    ...
    public class LmiWebhookReceiverServiceTests
    {
        ...
        [InlineData("https://somewhere.com/api/" + Constants.ApiForJobGroups, MessageContentType.Publish)]
        ...
        [InlineData(MessageContentType.Publish, WebhookCacheOperation.None, WebhookCommand.None)]
        [InlineData(MessageContentType.Publish, WebhookCacheOperation.CreateOrUpdate, WebhookCommand.PublishFromDraft)]
        [InlineData(MessageContentType.Publish, WebhookCacheOperation.Delete, WebhookCommand.PurgeFromPublished)]
        ...
        [Theory]
        [InlineData(EventTypePublished, WebhookCommand.PublishFromDraft, "https://somewhere.com/api/" + Constants.ApiForJobGroups)]
        [InlineData(EventTypeDeleted, WebhookCommand.PurgeFromPublished, "https://somewhere.com/api/" + Constants.ApiForJobGroups)]
