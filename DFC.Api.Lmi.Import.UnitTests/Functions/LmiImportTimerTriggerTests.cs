...
namespace DFC.Api.Lmi.Import.UnitTests.Functions
{
    ...
    {
        private readonly ILogger<LmiImportTimerTrigger> logger = A.Fake<ILogger<LmiImportTimerTrigger>>();
        ...
        {
            lmiImportTimerTrigger = new LmiImportTimerTrigger(logger, fakeLmiImportService);
        }
